...
_CHECKPOINT_FOR_DOC = "kbert-base-uncased"
...
class KBertForPreTrainingOutput(ModelOutput):
    """
    Output type of :class:`~transformers.KBertForPreTraining`.
    Args:
...
class KBertLMHeadModel(KBertPreTrainedModel):
    ...
    def __init__(self, config):
        ...
        if not config.is_decoder:
            logger.warning("If you want to use `KBertLMHeadModel` as a standalone, add `is_decoder=True.`")
