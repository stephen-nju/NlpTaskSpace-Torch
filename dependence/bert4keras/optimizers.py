...
from dependence.bert4keras.backend import keras, K, is_tf_keras
from dependence.bert4keras.snippets import is_string, string_matching
from dependence.bert4keras.snippets import is_one_of, insert_arguments
from dependence.bert4keras.backend import piecewise_linear
import re
