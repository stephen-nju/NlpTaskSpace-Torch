...
def query_span_f1(start_preds, end_preds, match_preds, start_label_mask, end_label_mask, match_labels, flat=False):
    """
...
class QuerySpanF1(Metric):
    ...
    def __init__(self,
                 ...
                 flat=False):
        super(QuerySpanF1, self).__init__(compute_on_step,
                                          dist_sync_on_step,
                                          process_group,
                                          dist_sync_fn,
                                          )
    ...
    def update(self,
               ...
               end_preds=None,
               match_preds=None,
               start_label_mask=None,
               end_label_mask=None,
               match_labels=None
               ):
        tp, fp, fn = query_span_f1(start_preds, end_preds, match_preds, start_label_mask, end_label_mask, match_labels,
                                   flat=self.flat)
...
#     match_pred = [[0, 0], [0, 1]]
#     label_mask = [1, 1]
#     print(query_span_f1(start_pred, end_pred, match_pred, label_mask))
