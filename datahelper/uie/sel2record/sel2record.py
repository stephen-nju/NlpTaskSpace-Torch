...
from datahelper.uie.extraction.predict_parser import get_predict_parser
from datahelper.uie.sel2record.record import EntityRecord, MapConfig, RelationRecord, EventRecord
import logging
